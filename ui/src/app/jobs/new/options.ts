...
export const modelArchs: ModelArch[] = [
  ...
  },
  {
    ...
    group: 'image',
    defaults: {
      'config.process[0].model.arch': ['sdxl', 'sdxl'],
      'config.process[0].model.name_or_path': ['AstraliteHeart/pony-diffusion-v6', defaultNameOrPath],
      'config.process[0].model.quantize': [false, false],
      'config.process[0].model.quantize_te': [false, false],
      'config.process[0].sample.sampler': ['ddpm', 'flowmatch'],
      'config.process[0].train.noise_scheduler': ['ddpm', 'flowmatch'],
  ...
  {
    name: 'sdxl_illustrious_v1',
    label: 'SDXL — Illustrious XL v1.0',
    group: 'image',
    defaults: {
      'config.process[0].model.arch': ['sdxl', 'sdxl'],
      'config.process[0].model.name_or_path': ['OnomaAIResearch/Illustrious-XL-v1.0', defaultNameOrPath],
      'config.process[0].model.quantize': [false, false],
      'config.process[0].model.quantize_te': [false, false],
      'config.process[0].sample.sampler': ['ddpm', 'flowmatch'],
      'config.process[0].train.noise_scheduler': ['ddpm', 'flowmatch'],
  ...
  {
    name: 'sdxl_illustrious_v2',
    label: 'SDXL — Illustrious XL v2.0',
    group: 'image',
    defaults: {
      'config.process[0].model.arch': ['sdxl', 'sdxl'],
      'config.process[0].model.name_or_path': ['OnomaAIResearch/Illustrious-XL-v2.0', defaultNameOrPath],
      'config.process[0].model.quantize': [false, false],
      'config.process[0].model.quantize_te': [false, false],
      'config.process[0].sample.sampler': ['ddpm', 'flowmatch'],
      'config.process[0].train.noise_scheduler': ['ddpm', 'flowmatch'],
